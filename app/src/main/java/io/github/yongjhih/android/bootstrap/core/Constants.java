...
public final class Constants {
    ...
    public static final class Auth {
         ...
         * Account type id
         */
        public static final String BOOTSTRAP_ACCOUNT_TYPE = "io.github.yongjhih.android.bootstrap";

        /**
         * Account name
         */
        public static final String BOOTSTRAP_ACCOUNT_NAME = " Andrew Chen";

        /**
         * Provider id
         */
        public static final String BOOTSTRAP_PROVIDER_AUTHORITY = "io.github.yongjhih.android.bootstrap.sync";
    ...
    public static final class Intent {
         ...
         */
        public static final String INTENT_PREFIX = "io.github.yongjhih.android.bootstrap.";
