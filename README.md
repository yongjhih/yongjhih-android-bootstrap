...
[![Build Status](https://travis-ci.org/AndroidBootstrap/io-github-yongjhih-android-bootstrap.svg?branch=master)](https://travis-ci.org/AndroidBootstrap/io-github-yongjhih-android-bootstrap)

This repository contains the source code for the [ Andrew Chen](http://www.androidbootstrap.com/)
Android app available from [Google Play](https://play.google.com/store/apps/details?id=io.github.yongjhih.android.bootstrap).

Please see the [issues](https://github.io.github.yongjhih.android.bootstrap/io-github-yongjhih-android-bootstrap/issues) section
to report any bugs or feature requests and to see the list of known issues.

Have a questions about  Andrew Chen? Ask away on the [io-github-yongjhih-android-bootstrap discussion forum](https://groups.google.com/forum/#!forum/io-github-yongjhih-android-bootstrap).

<a href="https://play.google.com/store/apps/details?id=io.github.yongjhih.android.bootstrap" alt="Download from Google Play">
...
code for the app will change:
  ...
  - From: __io.github.yongjhih.android.bootstrap__
  - To: __com/notify/app/mobile__

At that point all the source files that were located in ____io.github.yongjhih.android.bootstrap__ will be moved to the
new folder __com/notify/app/mobile__.

All import statments that reference the old resources (__R.io.github.yongjhih.android.bootstrap.R__) will now be renamed
...
signed with a different key.  Manually uninstall  Andrew Chen from your device and
...
## Acknowledgements
 ...
 Andrew Chen is a result of a template project I've developed over the years as well as
...
code in this project is based on the GitHub Gaug.es and GitHub Android app.
 ...
 Andrew Chen is built on the awesome [Parse.com API](http://www.parse.com/)
...
## Contributors
Thank you to all the [contributors](http://www.github.io.github.yongjhih.android.bootstrap/io-github-yongjhih-android-bootstrap/contributors) on
...
[pull requests](https://github.io.github.yongjhih.android.bootstrap/io-github-yongjhih-android-bootstrap/pulls).
